        ...
        <div class="container">
            <div class="sign-in-page">
                <div class="row">
                    <div class="col-md-6">
                        <center>
                            <img src="{{ asset('temp-front-end/assets/images/register.webp') }}" alt=""
                                width="100%">
                        </center>
                    ...
                    <div class="col-md-6 col-sm-6 create-new-account">
                        ...
                        <form class="register-form outer-top-xs" role="form" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    style="box-shadow: 0 0 5pt 2pt #D3D3D3;
                                    outline-width: 0px;"
                            ...
                            <div class="form-group">
                                ...
                                <input
                                    style="box-shadow: 0 0 5pt 2pt #D3D3D3;
                                    outline-width: 0px;"
                                    type="text" name="nama" autocomplete="off" value="{{ old('nama') }}"
                                    class="form-control unicase-form-control text-input" id="nama">
                                @error('nama')
                                    <span style="color: red;">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <input
                                    style="box-shadow: 0 0 5pt 2pt #D3D3D3;
                                    outline-width: 0px;"
                                    type="text" name="telpon" autocomplete="off" value="{{ old('telpon') }}"
                                    class="form-control unicase-form-control text-input" id="telpon">
                                @error('telpon')
                                    <span style="color: red;">{{ $message }}</span>
                                @enderror
                            </div>
