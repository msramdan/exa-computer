...
<body>
    ...
    <center>
        <h3>Exa Computer</h3>
        <span style="font-size: 11px">Jl. Tlogosari Raya Ruko Anda KAV 6, Tlogosari Kulon
            Kec. Pedurungan, Kota Semarang
            Semarang, Jawa Tengah 50196</span>
    ...
    <span style="font-size: 10px; float: right;margin-right:10px">Semarang, {{ date('d-m-Y') }}</span>
    <br>
    <br>
    <br>
    <br>
